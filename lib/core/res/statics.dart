...
class Statics {
  ...
  double get mainHeadingSize =>
      _responsiveSpace(22.px, 24.px, 26.px, 28.px, 30.px);
  double get subHeadingSize =>
      _responsiveSpace(12.px, 14.px, 16.px, 18.px, 20.px);
  double get buttonTextSize =>
      _responsiveSpace(20.px, 22.px, 24.px, 26.px, 26.px);

  double get bodyTextSize =>
      _responsiveSpace(14.px, 16.px, 18.px, 20.px, 22.px);
  double get subtitleTextSize =>
      _responsiveSpace(10.px, 12.px, 14.px, 16.px, 18.px);
  double get premiumTextSize =>
      _responsiveSpace(32.px, 34.px, 36.px, 38.px, 40.px);
  double get dialogHeadingSize =>
      _responsiveSpace(15.px, 17.px, 19.px, 21.px, 23.px);

  double get defaultIconSize =>
      _responsiveSpace(20.px, 20.px, 20.px, 22.px, 22.px);
  double get defaultPadding =>
      _responsiveSpace(22.px, 24.px, 26.px, 28.px, 30.px);
  double get bottomBarHeight =>
      _responsiveSpace(101.px, 103.px, 105.px, 107.px, 109.px);

  double get largeIconSize =>
      _responsiveSpace(46.px, 48.px, 50.px, 52.px, 54.px);

  double get premiumIconBox =>
      _responsiveSpace(46.px, 48.px, 50.px, 52.px, 54.px);
  double get premiumIconBoxPadding =>
      _responsiveSpace(8.px, 10.px, 12.px, 14.px, 16.px);
  double get inputContainerHeight =>
      _responsiveSpace(158.px, 160.px, 162.px, 164.px, 169.px);
  double get loadingAnimationSize =>
      _responsiveSpace(190.px, 200.px, 210.px, 220.px, 230.px);

  double get subscriptionContainerHeight =>
      _responsiveSpace(240.px, 255.px, 260.px, 300.px, 23.px);
  double get renewContainerHeight =>
      _responsiveSpace(68.px, 70.px, 72.px, 76.px, 23.px);
  ...
  double get xHeadingACustom =>
      _responsiveSpace(17.sp, 16.sp, 15.sp, 14.sp, 13.sp);
  ...
  double get subtitleLabel =>
      _responsiveSpace(16.sp, 14.sp, 12.sp, 12.sp, 10.sp);
  ...
  double get iconExtraSmallSize =>
      _responsiveSpace(12.sp, 15.sp, 15.sp, 14.sp, 14.sp);
  double get iconExtraASmallSize =>
      _responsiveSpace(8.sp, 16.sp, 12.sp, 14.sp, 16.sp);
  double get iconSmallSize =>
      _responsiveSpace(14.sp, 18.sp, 18.sp, 16.sp, 16.sp);
  double get iconSmallASize =>
      _responsiveSpace(14.sp, 18.sp, 18.sp, 18.sp, 18.sp);
  double get iconMediumSize =>
      _responsiveSpace(18.sp, 20.sp, 22.sp, 20.sp, 20.sp);
  double get iconMediumLargeSize =>
      _responsiveSpace(20.px, 22.px, 27.px, 30.px, 34.px);
  double get iconLargeSize =>
      _responsiveSpace(25.sp, 36.sp, 35.sp, 35.sp, 35.sp);

  double get extraSmallSpace =>
      _responsiveSpace(4.sp, 8.sp, 8.sp, 10.sp, 12.sp);
  ...
  double get smallAAASpace =>
      _responsiveSpace(8.sp, 14.sp, 10.sp, 20.sp, 20.sp);
  double get mediumSpace => _responsiveSpace(12.sp, 18.sp, 20.sp, 18.sp, 18.sp);
  double get mediumASpace =>
      _responsiveSpace(12.sp, 26.sp, 20.sp, 22.sp, 22.sp);
  double get mediumAASpace =>
      _responsiveSpace(12.sp, 22.sp, 20.sp, 22.sp, 22.sp);
  double get mediumToolScreenSpace =>
      _responsiveSpace(12.sp, 19.sp, 20.sp, 100.sp, 100.sp);
  double get largeSpace => _responsiveSpace(8.sp, 25.sp, 30.sp, 25.sp, 25.sp);
  double get doneBarHeight =>
      _responsiveSpace(30.sp, 28.sp, 30.sp, 25.sp, 25.sp);
  double get extraLargeSpace =>
      _responsiveSpace(20.sp, 20.sp, 40.sp, 45.sp, 50.sp);
  double get premiumIconWidth =>
      _responsiveSpace(30.sp, 35.sp, 60.sp, 35.sp, 35.sp);
  double get minusSpace => _responsiveSpace(20, 29.sp, 34.sp, 24.sp, 25.sp);
  double get minusExtraSpace =>
      _responsiveSpace(40.sp, 60.sp, 80.sp, 120.sp, 170.sp);
  double get addSpace => _responsiveSpace(30.sp, 35.sp, 50.sp, 30.sp, 30.sp);
  double get bottomPadding =>
      _responsiveSpace(30.sp, 50.sp, 50.sp, 30.sp, 38.sp);

  double get textSpace => _responsiveSpace(30.sp, 47.sp, 48.sp, 40.sp, 40.sp);
  double get dialogHeight =>
      _responsiveSpace(28.sp, 38.sp, 36.sp, 34.sp, 35.sp);
